...
public class PG_MDB_Q3 {
    ...
    private DBConnectionDetails innerDB2connection = new JDBCConnectionDetails("mdb-1", 3306, "bdapro_user", "bdapro_password", "bdapro_database");
    ...
    public static void setupDB() throws SQLException {
        ...
        dbConn2 = DriverManager.getConnection("jdbc:mariadb://localhost:8083/bdapro_database", "bdapro_user", "bdapro_password");
    }
    ...
    public void setup() throws IOException, SQLException {
        ...
        types2.put("localhost:8081", DefaultDBTypes.MARIADB);
        ...
        hostMappings2.put("mdb-1:3306", "localhost:8083");
